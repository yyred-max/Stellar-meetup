...
(function (Policy) {
    function IsExactOptionalProperty(value, key, expression) {
        return index_3.TypeSystemPolicy.ExactOptionalPropertyTypes ? `(${StringConstant(key)} in ${value} ? ${expression} : true)` : `(${MemberExpression(value, key)} !== undefined ? ${expression} : true)`;
    }
...
(function (TypeCompiler) {
    ...
    function* FromKind(schema, references, value) {
        ...
        yield `kind(${StringConstant(schema[index_7.Kind])}, ${instance}, ${value})`;
    }
