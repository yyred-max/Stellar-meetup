...
export declare const ValAddressRequired: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
export declare const RedelegateDstValAddressRequired: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
...
export declare const ConcordiumTrustedMetadataServiceError: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
export declare const ConcordiumAddressVerificationFailedError: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
export declare const ConcordiumInvalidMaxFeeError: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
...
export declare const InvalidParameterError: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
...
export declare const StatusCodes: {
    ...
    CLA_NOT_SUPPORTED_BOOTLOADER: number;
    CODE_BLOCKED: number;
