...
exports.MosaicDefinition = schema_utils_1.Type.Object({
  ...
  properties: schema_utils_1.Type.Optional(schema_utils_1.Type.Array(schema_utils_1.Type.Object({
    name: schema_utils_1.Type.Union([schema_utils_1.Type.Literal('divisibility'), schema_utils_1.Type.Literal('initialSupply'), schema_utils_1.Type.Literal('supplyMutable'), schema_utils_1.Type.Literal('transferable')]),
...
exports.NEMTransferTransaction = schema_utils_1.Type.Intersect([exports.TransactionCommon, schema_utils_1.Type.Object({
...
exports.NEMImportanceTransaction = schema_utils_1.Type.Intersect([exports.TransactionCommon, schema_utils_1.Type.Object({
...
exports.NEMAggregateModificationTransaction = schema_utils_1.Type.Intersect([exports.TransactionCommon, schema_utils_1.Type.Object({
...
exports.NEMProvisionNamespaceTransaction = schema_utils_1.Type.Intersect([exports.TransactionCommon, schema_utils_1.Type.Object({
...
exports.NEMMosaicCreationTransaction = schema_utils_1.Type.Intersect([exports.TransactionCommon, schema_utils_1.Type.Object({
...
exports.NEMSupplyChangeTransaction = schema_utils_1.Type.Intersect([exports.TransactionCommon, schema_utils_1.Type.Object({
...
exports.NEMRegularTransaction = schema_utils_1.Type.Union([exports.NEMTransferTransaction, exports.NEMImportanceTransaction, exports.NEMAggregateModificationTransaction, exports.NEMProvisionNamespaceTransaction, exports.NEMMosaicCreationTransaction, exports.NEMSupplyChangeTransaction]);
exports.NEMMultisigTransaction = schema_utils_1.Type.Intersect([exports.TransactionCommon, schema_utils_1.Type.Object({
  type: schema_utils_1.Type.Union([schema_utils_1.Type.Literal(constants_1.NEM.TxType.COSIGNING), schema_utils_1.Type.Literal(constants_1.NEM.TxType.MULTISIG), schema_utils_1.Type.Literal(constants_1.NEM.TxType.MULTISIG_SIGNATURE)]),
