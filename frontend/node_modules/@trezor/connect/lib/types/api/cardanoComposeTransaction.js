...
exports.CardanoComposeTransactionParamsSchema = schema_utils_1.Type.Object({
  ...
  outputs: schema_utils_1.Type.Optional(schema_utils_1.Type.Array(schema_utils_1.Type.Intersect([schema_utils_1.Type.Object({
    ...
    $id: 'BaseOutput'
  }), schema_utils_1.Type.Union([schema_utils_1.Type.Object({
    address: schema_utils_1.Type.String(),
    amount: schema_utils_1.Type.String(),
  ...
  addressParameters: schema_utils_1.Type.Object({
    addressType: protobuf_1.MessagesSchema.EnumCardanoAddressType,
