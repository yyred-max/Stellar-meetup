...
const cardanoComposeTransaction_1 = require("../../../types/api/cardanoComposeTransaction");
...
class CardanoComposeTransaction extends AbstractMethod_1.AbstractMethod {
  init() {
    ...
    (0, schema_utils_1.AssertWeak)(cardanoComposeTransaction_1.CardanoComposeTransactionParamsSchema, payload);
  ...
  run() {
    ...
    const result = feeLevels.map(({
      ...
      try {
        const txPlan = (0, cardanoUtils_1.composeTxPlan)(account.descriptor, account.utxo, outputs, certificates, withdrawals, changeAddress.address, !!testnet, {
        ...
        if (error instanceof coin_selection_1.CoinSelectionError && error.code === 'UTXO_BALANCE_INSUFFICIENT') {
          return {
            type: 'error',
