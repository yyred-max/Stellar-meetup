...
const transformPoolParameters = poolParameters => {
  ...
  return {
    ...
    poolOwners: poolParameters.owners.map(owner => ({
      ...
      staking_key_path: owner.stakingKeyPath ? (0, pathUtils_1.validatePath)(owner.stakingKeyPath, 5) : undefined
    })),
...
const transformCertificate = certificate => {
  ...
  if (certificate.type === constants_1.PROTO.CardanoCertificateType.STAKE_REGISTRATION_CONWAY || certificate.type === constants_1.PROTO.CardanoCertificateType.STAKE_DEREGISTRATION_CONWAY) {
