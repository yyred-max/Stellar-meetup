...
const transformOutput = output => {
  ...
  const result = {
    output: {
      ...
      inline_datum_size: output.inlineDatum ? (0, cardanoUtils_1.hexStringByteLength)(output.inlineDatum) : undefined,
      reference_script_size: output.referenceScript ? (0, cardanoUtils_1.hexStringByteLength)(output.referenceScript) : undefined
    },
