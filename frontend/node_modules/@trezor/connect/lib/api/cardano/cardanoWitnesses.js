...
const gatherWitnessPaths = (inputsWithPath, certificatesWithPoolOwnersAndRelays, withdrawals, collateralInputsWithPath, requiredSigners, additionalWitnessRequests, signingMode) => {
  ...
  if (signingMode !== constants_1.PROTO.CardanoTxSigningMode.MULTISIG_TRANSACTION) {
    ...
    certificatesWithPoolOwnersAndRelays.forEach(({
      ...
      if (certificate.path && (certificate.type === constants_1.PROTO.CardanoCertificateType.STAKE_DELEGATION || certificate.type === constants_1.PROTO.CardanoCertificateType.STAKE_DEREGISTRATION || certificate.type === constants_1.PROTO.CardanoCertificateType.STAKE_REGISTRATION_CONWAY || certificate.type === constants_1.PROTO.CardanoCertificateType.STAKE_DEREGISTRATION_CONWAY || certificate.type === constants_1.PROTO.CardanoCertificateType.VOTE_DELEGATION)) {
