...
const Params = schema_utils_1.Type.Intersect([schema_utils_1.Type.Union([schema_utils_1.Type.Omit(ethereum_1.EthereumSignTypedData, schema_utils_1.Type.Literal('path')), schema_utils_1.Type.Omit(ethereum_1.EthereumSignTypedHash, schema_utils_1.Type.Literal('path'))]), schema_utils_1.Type.Object({
...
class EthereumSignTypedData extends AbstractMethod_1.AbstractMethod {
  ...
  async run() {
    ...
    if (this.device.features.internal_model === device_utils_1.DeviceModelInternal.T1B1) {
