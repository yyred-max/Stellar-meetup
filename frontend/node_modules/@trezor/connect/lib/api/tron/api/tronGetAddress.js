...
class TronGetAddress extends AbstractMethod_1.AbstractMethod {
  hasBundle;
  progress = 0;
  init() {
  ...
  get confirmation() {
    return {
      view: 'export-address',
      label: this.params.length > 1 ? 'Export multiple Tron addresses' : `Export Tron address for account #${(0, pathUtils_1.fromHardened)(this.params[0].address_n[2]) + 1}`
    };
  }
  async _call({
    address_n,
...
exports.default = TronGetAddress;
//# sourceMappingURL=tronGetAddress.js.map