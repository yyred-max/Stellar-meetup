...
export declare abstract class AbstractApiTransport extends AbstractTransport {
    ...
    get apiType(): import("../types").ApiType;
    ...
    subscribe({ path, channels, signal, }: {
        ...
        error: "unexpected error";
        message: string;
    } | import("../types").Success<Record<OpenDeviceChannel, boolean>>>;
    ...
    call({ session, name, data, protocol: customProtocol, thpState, signal, timeout, }: AbstractTransportMethodParams<'call'>): Promise<{
        ...
        type: "TronSignTx";
        message: import("@trezor/protobuf/lib/messages").TronSignTx;
    } | {
        type: "TronContractRequest";
        message: import("@trezor/protobuf/lib/messages").TronContractRequest;
    } | {
        ...
        message: import("@trezor/protobuf/lib/messages").TronFreezeBalanceV2Contract;
    } | {
        type: "TronUnfreezeBalanceV2Contract";
        message: import("@trezor/protobuf/lib/messages").TronUnfreezeBalanceV2Contract;
    } | {
        type: "TronWithdrawUnfreeze";
        message: import("@trezor/protobuf/lib/messages").TronWithdrawUnfreeze;
    } | {
        type: "TronSignature";
        message: import("@trezor/protobuf/lib/messages").TronSignature;
    } | {
        type: "TronRawParameter";
        message: import("@trezor/protobuf/lib/messages").TronRawParameter;
    } | {
        type: "TronRawContract";
        message: import("@trezor/protobuf/lib/messages").TronRawContract;
    } | {
        type: "TronRawTransaction";
        message: import("@trezor/protobuf/lib/messages").TronRawTransaction;
    }> | {
        success: false;
        error: any;
        message: string | undefined;
