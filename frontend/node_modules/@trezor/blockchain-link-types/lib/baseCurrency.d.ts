export declare const fiatBaseCurrencies: {
    readonly usd: {
        readonly code: "usd";
...
export declare const valuablesBaseCurrencies: {
    readonly btc: {
        readonly code: "btc";
...
export declare const valuablesBaseCurrencyCodes: ("btc" | "xag" | "xau")[];
...
export declare const isBaseCurrencyCode: (code: string) => code is BaseCurrencyCode;
