...
import type { TokenDetailByMint, TokenInfo, TokenStandard } from '@trezor/blockchain-link-types/lib';
...
export declare const tokenStandardToTokenProgramName: (standard: TokenStandard) => TokenProgramName;
