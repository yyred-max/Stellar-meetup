...
export declare function compile(chunks: Buffer | Stack): Buffer<ArrayBufferLike>;
...
export declare function fromASM(asm: string): Buffer<ArrayBufferLike>;
export declare function toStack(chunks0: Buffer | Stack): Buffer<ArrayBuffer>[];
