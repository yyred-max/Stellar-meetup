...
const getJWSPublicKey = (use) => {
    if (['message-system', 'token-definitions'].includes(use)) {
        return isCodesignBuild() ? jws_1.publicKey.codesign : jws_1.publicKey.dev;
    }
    return isCodesignBuild() ? jws_1.firmwareConfigPublicKey.codesign : jws_1.firmwareConfigPublicKey.dev;
};
