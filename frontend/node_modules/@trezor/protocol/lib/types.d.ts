export { ThpPairingMethod, type ThpDeviceProperties, type ThpCredentials, } from './protocol-thp/messages';
...
export { TrezorPushNotificationType, TrezorPushNotificationMode, type DecodedTrezorPushNotification, } from './protocol-tpn/index';
