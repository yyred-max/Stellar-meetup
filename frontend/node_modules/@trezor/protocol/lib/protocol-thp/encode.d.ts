...
export declare const encodePayload: (name: string, data: Record<string, unknown>, thpState: ThpState) => Buffer<ArrayBufferLike>;
...
export declare const encodeAck: (state: ThpState) => Buffer<ArrayBuffer>;
