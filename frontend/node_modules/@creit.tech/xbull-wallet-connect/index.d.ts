import { IConnectParams, IConnectResponseData, IConnectResult, InitialResponseListenerData, IRejectResponse, IRejectResult, ISDKConstructor, ISignMessageResponseData, ISignMessageResult, ISignParams, ISignResponseData, ISignResult } from './interfaces';
...
export declare class xBullWalletConnect {
    ...
    signMessageResponse$: Subject<MessageEvent<ISignMessageResponseData | IRejectResponse>>;
    signMessageResult$: Subject<ISignMessageResult | IRejectResult>;
    ...
    onSignMessageResponseSubscription: Subscription;
