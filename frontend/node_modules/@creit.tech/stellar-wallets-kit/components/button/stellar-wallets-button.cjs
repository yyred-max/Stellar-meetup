...
var account_service = require('../../services/account.service.cjs');
var clipboard_service = require('../../services/clipboard.service.cjs');
var reactiveState = require('../../state/reactive-state.cjs');
var store = require('../../state/store.cjs');
var styles = require('./styles.cjs');

exports.ButtonThemeType = void 0;
(function (ButtonThemeType) {
    ButtonThemeType["DARK"] = "DARK";
    ButtonThemeType["LIGHT"] = "LIGHT";
})(exports.ButtonThemeType || (exports.ButtonThemeType = {}));
const ButtonThemes = {
    DARK: {
        bgColor: '#161616',
        textColor: '#a0a0a0',
...
exports.StellarWalletsButton = class StellarWalletsButton extends lit.LitElement {
    constructor() {
        super(...arguments);
        this.buttonText = 'Connect';
        this.showDropdown = false;
        this.showCopiedMessage = false;
        this.activeAddress = new reactiveState.ReactiveState(this, store.activeAddress$);
        this.theme = new reactiveState.ReactiveState(this, store.buttonTheme$);
    }
    static { this.styles = [
        lit.css `
      :host * {
    ...
    async copyPublicKey() {
        await clipboard_service.copyToClipboard(this.activeAddress.value);
    ...
    async startBalanceFetcher() {
        ...
        if (horizonUrl) {
            this.fetchAddressSubscription = this.activeAddress.value$
                .pipe(rxjs.switchMap(async (value) => {
                return value ? account_service.fetchAccountBalance(value).catch(() => '0') : '0';
            }))
                .subscribe((balance) => {
    ...
    `;
        const dropdown = this.showDropdown
          ...
          <section class="dropdown-wrapper">
            ...
            <div class="dropdown-profile">
              ...
              ${this.accountBalance
                ? lit.html `<h3 style="margin: 0" class="dropdown-text">${this.accountBalance} XLM</h3>`
                : ''}
            </div>
        ...
        `
            : '';
        return lit.html `
      <section style=${styleMap_js.styleMap(this.getThemeStyles)} class="btn-container">${button} ${dropdown}</section>
    `;
    }
};
tslib.__decorate([
    decorators_js.property({ type: String, reflect: true })
], exports.StellarWalletsButton.prototype, "buttonText", void 0);
tslib.__decorate([
    decorators_js.state()
], exports.StellarWalletsButton.prototype, "showDropdown", void 0);
tslib.__decorate([
    decorators_js.state()
], exports.StellarWalletsButton.prototype, "accountBalance", void 0);
tslib.__decorate([
    decorators_js.state()
], exports.StellarWalletsButton.prototype, "showCopiedMessage", void 0);
exports.StellarWalletsButton = tslib.__decorate([
    decorators_js.customElement('stellar-wallets-button')
], exports.StellarWalletsButton);

exports.ButtonThemes = ButtonThemes;
//# sourceMappingURL=stellar-wallets-button.cjs.map
